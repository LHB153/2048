String.toLocaleString({
  ...
  "zh": {
    ...
    "%game-won"             : "你赢了！",
    "%game-over"            : "游戏结束！",
    "%game-explanation"     : "<strong class=\"important\">如何玩：</strong>使用你的<strong>箭头键</strong>移动砖块。当两个带有相同符号的砖块接触时，它们会<strong>升级！</strong>",
    "%disclaimer"           : "<strong class=\"important\">注意：</strong>本网站<a href=\"http://git.io/cupcakes\">git.io/cupcakes</a>是官方版本<a href=\"http://git.io/2048\">2048</a>的衍生作品，由<a href=\"http://gabrielecirulli.com\" target=\"_blank\">Gabriele Cirulli</a>创建。",
    "%credits"              : "纸杯蛋糕图片由<a href=\"http://www.georgetowncupcake.com/\" title=\"Georgetown Cupcake | DC Cupcakes | About\">乔治城纸杯蛋糕</a>提供。",
    "%tweet1"               : "我在2048-纸杯蛋糕游戏中得分\"",
    "%tweet2"               : " #2048游戏",
    "%tile-legend"          : "<strong class=\"important\">砖块图例：</strong>",
    '%2'                    : '香草生日',
    '%4'                    : '泡泡糖粉',
    '%8'                    : '阳光香草',
    '%16'                   : '瓦尔罗纳白巧克力酱',
